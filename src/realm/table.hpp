...
public:
    ...
    // Create an object with specific ObjectID.
    Obj create_object(ObjectID object_id, const FieldValues& = {});
    ...
    ObjKey get_obj_key(ObjectID id) const;
    ObjectID get_object_id(ObjKey key) const;
